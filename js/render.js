...
Renderer.trap = class {
	...
	static getRenderedTrapPart (renderer, ent, {styleHint = null} = {}) {
...
Renderer.traphazard = class {
	...
	static getCompactRenderedString (ent, opts) {
		...
		return `
			...
			${Renderer.trap.getRenderedTrapPart(renderer, ent, {styleHint})}
			</td></tr>
		`
    }
